...
public class Collector extends SubsystemBase
{
    ...
    public double encoderToAngleFactor = ((1.0/Constants.Falcon500.TICKS_PER_REV)/Constants.Collector.GEAR_RATIO)*360;
    ...
    public double getCollectorAngleError()
    {
        return collectorMotor1.getClosedLoopError();
    }
}
